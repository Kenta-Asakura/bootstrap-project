...
})({"gntPC":[function(require,module,exports) {
...
/*!
  ...
  */ !function(t, e) {
    module.exports = e(require("390ba56173c91825"));
}(this, function(t) {
    "use strict";
    function e(t) {
    ...
    const Vt = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top", Kt = ".sticky-top", Qt = "padding-right", Xt = "margin-right";
    class Yt {
        constructor(){
    ...
    const ge = new Set([
        ...
        "src",
        "xlink:href"
    ]), fe = /^(?:(?:https?|mailto|ftp|tel|file|sms):|[^#&/:?]*(?:[#/?]|$))/i, me = /^data:(?:image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp)|video\/(?:mpeg|mp4|ogg|webm)|audio\/(?:mp3|oga|ogg|opus));base64,[\d+/a-z]+=*$/i, pe = (t, e)=>{
    ...
    const Ee = new Set([
        ...
        "allowList",
        "sanitizeFn"
    ]), Ce = "fade", Te = "show", ke = ".modal", Se = "hide.bs.modal", Le = "hover", Oe = "focus", Ie = {
        AUTO: "auto",
        TOP: "top",
        RIGHT: p() ? "left" : "right",
        BOTTOM: "bottom",
    ...
    class Pe extends W {
        ...
        _setListeners() {
            ...
            for (const e of t)if ("click" === e) F.on(this._element, this.constructor.eventName("click"), this._config.selector, (t)=>{
                ...
                const t = e === Le ? this.constructor.eventName("mouseenter") : this.constructor.eventName("focusin"), s = e === Le ? this.constructor.eventName("mouseleave") : this.constructor.eventName("focusout");
    ...
    b(je);
    const Fe = "click.bs.scrollspy", $e = "active", ze = "[href]", He = {
        offset: null,
    ...
    class qe extends W {
        ...
        _activateParents(t) {
            ...
            else for (const e of V.parents(t, ".nav, .list-group"))for (const t of V.prev(e, ".nav-link, .nav-item > .nav-link, .list-group-item"))t.classList.add($e);
        }
        _clearActiveClass(t) {
    ...
    const Ze = "hide", ts = "show", es = "showing", ss = {
        animation: "boolean",
        autohide: "boolean",
        delay: "number"
    }, is = {
...
},{"390ba56173c91825":"7unqC"}],"7unqC":[function(require,module,exports) {
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gntPC","boekP"], "boekP", "parcelRequire5914")
